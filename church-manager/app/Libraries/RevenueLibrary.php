...
class RevenueLibrary implements \App\Interfaces\LibraryInterface {
    ...
    function setListQueryFields(){
        $fields = ['revenues.id','denomination_id','revenues.name','revenues.description'];
        return $fields;
    }

    function setViewQueryFields(){
        $fields = ['revenues.id','denomination_id','revenues.name','revenues.description','denominations.name as denomination_name'];
        return $fields;
    }
