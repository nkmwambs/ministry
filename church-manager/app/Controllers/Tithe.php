...
class Tithe extends WebController
{
    ...
    public function index($parent_id = ''): string
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            return view('tithe/list', $page_data);
        }else{
    ...
    function post(){
        ...
        return redirect()->to(site_url("tithes/view/".hash_id($insertId)));
    }
    ...
    public function update(){
        ...
        return redirect()->to(site_url("tithe/view/".$hashed_id))->with('message', 'Tithe updated successfully!');
    }
}
