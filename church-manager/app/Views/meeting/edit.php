    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                <form id="frm_edit_meeting" method="post" action="<?=site_url('meetings/update/');?>" role="form" class="form-horizontal form-groups-bordered">
                    ...
                    <input type="hidden" name="id" id = "meeting_id" value="<?=$id;?>" />
