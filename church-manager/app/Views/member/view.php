<div class="row">
    <div class="col-xs-12">
        <div class="page-title"><i class='fa fa-trophy'></i> <?= lang('member.view_members'); ?></div>
    </div>
</div>
                ...
                <tr>
                    <td>
                        <span class='action-icons' title="View <?= singular($member['first_name']); ?> member">
                            <a href="<?= site_url("members/view/".hash_id($member['id'])); ?>"><i class='fa fa-search'></i></a>
                        </span>
                        <span class='action-icons' title="Edit <?= singular($member['first_name']); ?> member">
                            <i style="cursor:pointer" onclick="showAjaxModal('members','edit', '<?=hash_id($member['id']);?>')" class='fa fa-pencil'></i>
                        </span>
