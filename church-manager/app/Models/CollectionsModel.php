...
class CollectionsModel extends Model
{
    ...
    protected $allowedFields    = ['id','return_date','period_start_date','period_end_date','assembly_id','collection_type_id','amount','status','collection_reference','description','collection_method'];
