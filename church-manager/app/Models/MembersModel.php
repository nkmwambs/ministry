...
class MembersModel extends Model
{
    ...
    protected $allowedFields    = ['id','first_name','last_name','saved_date','gender','assembly_id','parent_id','member_number','designation_id','date_of_birth','email','phone','is_active'];
