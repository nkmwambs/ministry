...
class VisitorLibrary implements \App\Interfaces\LibraryInterface {
    ...
    function setListQueryFields(){
        $fields = ['visitors.id','first_name','last_name','visitors.phone','visitors.email','gender','date_of_birth','event_id','payment_id','payment_code','registration_amount','status'];
        return $fields;
    }
