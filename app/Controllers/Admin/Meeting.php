...
class Meeting extends WebController
{
    ...
    public function post() {
        ...
        if ($this->request->isAJAX()) {
            ...
            return view($this->session->get('user_type').'/meeting/list', parent::page_data($records));
        }
    ...
    public function update() {
        ...
        return redirect()->to(site_url($this->session->get('user_type')."/meeting/view".$hashed_id));
    }
}
