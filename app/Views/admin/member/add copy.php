      ...
      <div class="panel-heading">
        ...
        <div class="panel-options">
          <ul class="nav nav-tabs">
            <li class="nav-item active"><a class = "nav-link"  href="#basic" id = "standard_tab" data-toggle="tab"><?=lang("member.add_member_basic");?></a></li>
            <?php if ($customFields): ?>
            <li class = "nav-item"><a class = "nav-link" href="#additional" id = "additional_tab" data-toggle="tab"><?=lang("member.add_member_additional");?></a></li>
            <?php endif; ?>
          </ul>
        </div>
