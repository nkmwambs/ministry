            ...
            <div class="panel-body">
                ...
                <form role="form" id="frm_add_member" method="post" action="<?= site_url("members/save") ?>" class="form-horizontal form-groups-bordered">
                    ...
                    <div class='form-group'>
                        ...
                        <div class="col-xs-6">
                            <input type="date" class="form-control" id="membership_date" name="membership_date" placeholder="Enter Membership Date" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <input type="date" class="form-control" name="date_of_birth" id="date_of_birth" placeholder="Enter Date of Birth"></i>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <input type="date" class="form-control" name="saved_date" id="saved_date" placeholder="Enter Saved Date"></i>
                        </div>
                    </div>
